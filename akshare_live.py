...
ALL_CONTRACTS = {
    # 2026-09-08 全量同步 minishare 权威主力合约
    # SYMBOLS 里有 54 个品种，此处全部覆盖
    "AP": "AP2701", "CF": "CF2701", "FG": "FG2701",
    "J": "J2701", "JM": "JM2701",
    "MA": "MA2610", "OI": "OI2701",
    "PF": "PF2611", "PK": "PK2611", "PR": "PR2611", "PX": "PX2611",
    "RM": "RM2611", "SA": "SA2701", "SA01": "SA2701",
    "SH": "SH2611", "SR": "SR2701", "TA": "TA2701", "UR": "UR2701",
    "a": "A2611", "ag": "AG2610", "al": "AL2610", "ao": "AO2701",
    "au": "AU2610", "b": "B2611", "bu": "BU2611", "c": "C2611",
    "cs": "CS2611", "cu": "CU2610", "eb": "EB2610", "ec": "EC2610",
    "eg": "EG2610", "fu": "FU2611", "hc": "HC2701", "i": "I2701",
    "jd": "JD2611", "l": "L2701", "lc": "LC2610", "lh": "LH2611",
    "m": "M2701", "ni": "NI2610", "p": "P2701", "pg": "PG2610",
    "pp": "PP2701", "rb": "RB2701", "rr": "RR2610", "ru": "RU2701",
    "sc": "SC2610", "si": "SI2610", "sn": "SN2610", "sp": "SP2611",
    "ss": "SS2610", "v": "V2701", "y": "Y2701", "zn": "ZN2610",
}
    ...
    def poll(self, symbols=None):
        ...
        if current_errors >= len(syms) * 0.8:  # 80% 以上品种失败
            ...
            if self._error_count <= self._max_errors:
                print(
                    f"[akshare_live] ℹ️ {now_str} 大部分品种无数据（可能休市），已获取 {len(results)}/{len(syms)} 个品种"
                )
