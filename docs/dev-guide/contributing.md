...
不适行为可以通过[安全策略](../resources/security.md)中列出的方式联系维护者。
...
项目遵循 **Conventional Commits** 提交规范。完整说明请参阅 [提交规范](commit-conventions.md)。
