...
EVENTS = [
    # —— 每日时段（提醒用，非风险）——
    {"name": "日盘开盘", "kind": "时段", "imp": "低", "wd": None, "hh": 9, "mm": 0, "win": 0.5,
     "note": "流动性恢复，但开盘前15分钟常跳空"},
    {"name": "日盘收盘", "kind": "时段", "imp": "低", "wd": None, "hh": 15, "mm": 0, "win": 0.5,
     "note": "收盘前注意减仓/平仓，避免隔夜跳空"},
    {"name": "夜盘开盘", "kind": "时段", "imp": "低", "wd": None, "hh": 21, "mm": 0, "win": 0.5,
     "note": "外盘联动时段，波动加大"},
    {"name": "夜盘收盘", "kind": "时段", "imp": "低", "wd": None, "hh": 23, "mm": 0, "win": 0.5,
     "note": "部分品种23:00收，注意持仓过夜风险"},

    # —— 宏观（美国时段，北京时间）——
    {"name": "EIA原油库存", "kind": "宏观", "imp": "高", "wd": 2, "hh": 22, "mm": 30, "win": 2.0,
     "note": "每周三22:30，原油/化工(燃油/PTA)瞬间波动大"},
    {"name": "美国非农就业", "kind": "宏观", "imp": "高", "wd": 4, "hh": 20, "mm": 30, "win": 2.0,
     "note": "每月第一周五20:30，全商品共振，金银/有色/股指最敏感"},
    {"name": "美国CPI", "kind": "宏观", "imp": "高", "wd": None, "hh": 20, "mm": 30, "win": 2.0,
     "note": "多在每月中旬某日20:30(夏令)/21:30(冬令)，需盯exact日历"},
    {"name": "美联储FOMC利率决议", "kind": "宏观", "imp": "高", "wd": None, "hh": 2, "mm": 0, "win": 3.0,
     "note": "每年8次(约6周一次)凌晨2:00公布+2:30鲍威尔，金银/股指巨震"},
    {"name": "美国初请失业金", "kind": "宏观", "imp": "中", "wd": 3, "hh": 20, "mm": 30, "win": 1.0,
     "note": "每周四20:30，影响有限但叠加其他数据会放大"},
    {"name": "美国GDP/耐用品订单", "kind": "宏观", "imp": "中", "wd": None, "hh": 20, "mm": 30, "win": 1.5,
     "note": "月底/季末不定期，美元系品种留意"},

    # —— 中国宏观/产业 ——
    {"name": "中国CPI/PPI(统计局)", "kind": "宏观", "imp": "中", "wd": None, "hh": 9, "mm": 30, "win": 1.5,
     "note": "每月9-15日某日09:30，黑色/农产品情绪影响"},
    {"name": "中国社融/信贷数据", "kind": "宏观", "imp": "中", "wd": None, "hh": 16, "mm": 0, "win": 1.5,
     "note": "每月10-15日盘后公布，次日开盘易跳"},
    {"name": "交易所持仓排名(龙虎榜)", "kind": "交易所", "imp": "中", "wd": 4, "hh": 15, "mm": 30, "win": 1.0,
     "note": "每日收盘后交易所公布，周五更受关注；本系统已有 cpos_rank 模块"},

    # —— 产业周度数据 ——
    {"name": "Mysteel钢材库存/产量", "kind": "产业", "imp": "高", "wd": 3, "hh": 11, "mm": 0, "win": 2.0,
     "note": "每周四约11:00，螺纹/热卷/焦煤焦炭定价锚"},
    {"name": "找钢网库存数据", "kind": "产业", "imp": "中", "wd": 2, "hh": 11, "mm": 30, "win": 1.5,
     "note": "每周三中午，黑色系情绪扰动"},
    {"name": "港口铁矿石库存", "kind": "产业", "imp": "中", "wd": 4, "hh": 15, "mm": 30, "win": 1.5,
     "note": "每周五下午，铁矿/黑色链"},
    {"name": "USDA出口销售/供需报告", "kind": "产业", "imp": "高", "wd": 4, "hh": 0, "mm": 30, "win": 2.0,
     "note": "周四半夜(北京时间周五00:30左右)，豆粕/豆油/玉米/棉花跳空"},
    {"name": "生猪周度出栏/屠宰数据", "kind": "产业", "imp": "中", "wd": 5, "hh": 12, "mm": 0, "win": 1.5,
     "note": "每周六机构汇总，影响周一生猪开盘预期"},
    {"name": "钢联/卓创化工开工率", "kind": "产业", "imp": "中", "wd": 3, "hh": 17, "mm": 0, "win": 1.5,
...
def upcoming(lookahead_hours=24, now=None):
    ...
    for ev in EVENTS:
        ...
        if occ <= horizon:
            ...
            out.append({
                "name": ev["name"], "kind": ev["kind"], "imp": ev["imp"],
                "time": occ.strftime("%Y-%m-%d %H:%M"), "in_hours": in_h,
                "win": ev["win"], "note": ev["note"],
            })
