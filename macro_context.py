...
def compute():
    ...
    out.update(
        {
            ...
            "equity_mom": round(equity_mom, 4),
            "rate_trend": round(rate_trend, 4),
            "fx_trend": round(fx_trend, 4),
            "available": True,
        }
    )
    ...
    out.update(
        {
            "crude_mom": round(crude_mom, 4),
            "nh_mom": round(nh_mom, 4),
            "ag_mom": round(ag_mom, 4),
            "crude_available": len(crude) >= 21,
            "nh_available": len(nh) >= 21,
